...
# Design
################################################################################
read_netlist -top proj_extender /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/post_elaboartion/proj_extender.v
read_metric -id current /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/post_elaboartion/proj_extender.metrics.json

phys::read_script /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/post_elaboartion/proj_extender.g

phys::read_lec_taf /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/post_elaboartion/proj_extender.lec.taf.gz
...
if {$_cell_area_ != "737"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 737,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "12"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 12,  current net area: $_net_area_"
}
unset _net_area_
