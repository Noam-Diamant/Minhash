...
#
# Init setup file
# Created by Genus(TM) Synthesis Solution on 08/08/2024 20:31:46
#
################################################################################
...
read_netlist /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/post_elaboartion/proj_hasher.v
