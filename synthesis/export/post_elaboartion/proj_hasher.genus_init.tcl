...
#
# Init setup file
# Created by Genus(TM) Synthesis Solution on 08/07/2024 20:12:21
#
################################################################################
...
read_netlist /data/project/tsmc65/users/itaerg/ws/Final-Project/Minhash/synthesis/workspace/../export/post_elaboartion/proj_hasher.v
