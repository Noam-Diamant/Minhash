...
#
# Init setup file
# Created by Genus(TM) Synthesis Solution on 08/09/2024 12:36:38
#
################################################################################
...
read_netlist /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/post_elaboartion/proj_counter.v
