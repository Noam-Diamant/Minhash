...
#
# Init setup file
# Created by Genus(TM) Synthesis Solution on 08/06/2024 13:59:23
#
################################################################################
...
read_netlist /data/project/tsmc65/users/itaerg/ws/Final-Project/Minhash/synthesis/workspace/../export/post_elaboartion/proj_counter.v
