...
#
# Init setup file
# Created by Genus(TM) Synthesis Solution on 08/07/2024 19:52:41
#
################################################################################
...
read_netlist /data/project/tsmc65/users/itaerg/ws/Final-Project/Minhash/synthesis/workspace/../export/post_elaboartion/proj_kmer_buffer.v
