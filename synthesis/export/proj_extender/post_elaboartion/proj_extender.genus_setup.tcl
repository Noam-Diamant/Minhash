...
################################################################################
if {[::legacy::find -design design:proj_extender] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj design:proj_extender
}
...
# Design
################################################################################
read_netlist -top proj_extender /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_extender/post_elaboartion/proj_extender.v
read_metric -id current /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_extender/post_elaboartion/proj_extender.metrics.json

phys::read_script /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_extender/post_elaboartion/proj_extender.g

phys::read_lec_taf /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_extender/post_elaboartion/proj_extender.lec.taf.gz
...
# slack
set _slk_ [::legacy::get_attribute slack design:proj_extender]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
...
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns design:proj_extender]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area design:proj_extender]
if {[regexp {^-?[0-9.]+$} $_cell_area_]} {
  set _cell_area_ [format %.0f $_cell_area_]
}
if {$_cell_area_ != "99517"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 99517,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area design:proj_extender]
if {[regexp {^-?[0-9.]+$} $_net_area_]} {
  set _net_area_ [format %.0f $_net_area_]
}
if {$_net_area_ != "23"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 23,  current net area: $_net_area_"
}
unset _net_area_
