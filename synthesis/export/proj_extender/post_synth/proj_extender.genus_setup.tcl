...
# Design
################################################################################
read_netlist -top proj_extender /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_extender/post_synth/proj_extender.v
...
phys::read_script /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_extender/post_synth/proj_extender.g
...
if {$_slk_ != "482.7"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 482.7,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "36673"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 36673,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "13297"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 13297,  current net area: $_net_area_"
}
unset _net_area_
