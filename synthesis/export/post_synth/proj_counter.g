...
set_db -quiet runtime_by_stage {{PBS_Generic-Start 0 69 0.0 55.999199} {to_generic 4 73 3 59} {first_condense 0 73 0 60} {PBS_Generic_Opt-Post 5 74 3.9984290000000016 59.997628} {{PBS_Generic-Postgen HBO Optimizations} 0 74 0.0 59.997628} {PBS_TechMap-Start 0 82 0.0 67.997628} {{PBS_TechMap-Premap HBO Optimizations} 0 82 0.0 67.997628} {first_condense 1 83 0 69} {reify 1 84 0 69} {global_incr_map 0 84 0 69} {{PBS_Techmap-Global Mapping} 2 84 1.9873159999999928 69.984944} {{PBS_TechMap-Datapath Postmap Operations} 3 87 2.0 71.984944} {{PBS_TechMap-Postmap HBO Optimizations} 0 87 0.0 71.984944} {{PBS_TechMap-Postmap Clock Gating} 0 87 0.0 71.984944} {{PBS_TechMap-Postmap Cleanup} 7 94 7.0 78.984944} {PBS_Techmap-Post_MBCI 0 94 0.0 78.984944} {incr_opt 1 95 0 79} }
...
set_db -quiet flow_metrics_snapshot_uuid 308cb79f-339c-4400-86bf-1af2c3fdeeb8
...
external_delay -accumulate -output {412.5 412.5 412.5 412.5} -clock clock:proj_counter/clk -name proj_counter.sdc_line_17 {{port:proj_counter/index[7]}}
external_delay -accumulate -output {412.5 412.5 412.5 412.5} -clock clock:proj_counter/clk -name proj_counter.sdc_line_17_1_1 {{port:proj_counter/index[6]}}
external_delay -accumulate -output {412.5 412.5 412.5 412.5} -clock clock:proj_counter/clk -name proj_counter.sdc_line_17_2_1 {{port:proj_counter/index[5]}}
external_delay -accumulate -output {412.5 412.5 412.5 412.5} -clock clock:proj_counter/clk -name proj_counter.sdc_line_17_3_1 {{port:proj_counter/index[4]}}
external_delay -accumulate -output {412.5 412.5 412.5 412.5} -clock clock:proj_counter/clk -name proj_counter.sdc_line_17_4_1 {{port:proj_counter/index[3]}}
external_delay -accumulate -output {412.5 412.5 412.5 412.5} -clock clock:proj_counter/clk -name proj_counter.sdc_line_17_5_1 {{port:proj_counter/index[2]}}
external_delay -accumulate -output {412.5 412.5 412.5 412.5} -clock clock:proj_counter/clk -name proj_counter.sdc_line_17_6_1 {{port:proj_counter/index[1]}}
external_delay -accumulate -output {412.5 412.5 412.5 412.5} -clock clock:proj_counter/clk -name proj_counter.sdc_line_17_7_1 {{port:proj_counter/index[0]}}
external_delay -accumulate -output {412.5 412.5 412.5 412.5} -clock clock:proj_counter/clk -name proj_counter.sdc_line_17_8_1 port:proj_counter/finished_count
...
path_delay -paths [specify_paths -from {port:proj_counter/clk port:proj_counter/rst_n} -to {{port:proj_counter/index[7]} {port:proj_counter/index[6]} {port:proj_counter/index[5]} {port:proj_counter/index[4]} {port:proj_counter/index[3]} {port:proj_counter/index[2]} {port:proj_counter/index[1]} {port:proj_counter/index[0]} port:proj_counter/finished_count}]  -name proj_counter.sdc_line_18 -delay 1650.0 -setup -user_priority -892928
...
path_group -paths [specify_paths -lenient -from {{inst:proj_counter/out_index_reg[2]} {inst:proj_counter/out_index_reg[1]} {inst:proj_counter/out_index_reg[0]}} -to {{inst:proj_counter/out_index_reg[2]} {inst:proj_counter/out_index_reg[1]} {inst:proj_counter/out_index_reg[0]}}]  -name reg2reg -group cost_group:proj_counter/reg2reg
path_group -paths [specify_paths -lenient -from {port:proj_counter/clk port:proj_counter/rst_n} -to {{inst:proj_counter/out_index_reg[2]} {inst:proj_counter/out_index_reg[1]} {inst:proj_counter/out_index_reg[0]}}]  -name in2reg -group cost_group:proj_counter/in2reg
path_group -paths [specify_paths -lenient -from {{inst:proj_counter/out_index_reg[2]} {inst:proj_counter/out_index_reg[1]} {inst:proj_counter/out_index_reg[0]}} -to {{port:proj_counter/index[7]} {port:proj_counter/index[6]} {port:proj_counter/index[5]} {port:proj_counter/index[4]} {port:proj_counter/index[3]} {port:proj_counter/index[2]} {port:proj_counter/index[1]} {port:proj_counter/index[0]} port:proj_counter/finished_count}]  -name reg2out -group cost_group:proj_counter/reg2out
path_group -paths [specify_paths -lenient -from {port:proj_counter/clk port:proj_counter/rst_n} -to {{port:proj_counter/index[7]} {port:proj_counter/index[6]} {port:proj_counter/index[5]} {port:proj_counter/index[4]} {port:proj_counter/index[3]} {port:proj_counter/index[2]} {port:proj_counter/index[1]} {port:proj_counter/index[0]} port:proj_counter/finished_count}]  -name in2out -group cost_group:proj_counter/in2out
# BEGIN DFT SECTION
set_db -quiet dft_scan_style muxed_scan
set_db -quiet dft_scanbit_waveform_analysis false
# END DFT SECTION
set_db -quiet design:proj_counter .seq_reason_deleted_internal {{{out_index_reg[3]} {{constant 0}} {out_index[3]}} {{out_index_reg[4]} {{constant 0}} {out_index[4]}} {{out_index_reg[5]} {{constant 0}} {out_index[5]}} {{out_index_reg[6]} {{constant 0}} {out_index[6]}} {{out_index_reg[7]} {{constant 0}} {out_index[7]}}}
set_db -quiet design:proj_counter .max_transition 350.0
set_db -quiet design:proj_counter .max_fanout 16.000
set_db -quiet design:proj_counter .qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 234} {cell_count 40} {utilization  0.00} {runtime 4 73 3 59} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 91} {cell_count 16} {utilization  0.00} {runtime 0 73 0 60} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 89} {cell_count 16} {utilization  0.00} {runtime 1 83 0 69} }{reify {wns 661} {tns 0} {vep 0} {area 44} {cell_count 10} {utilization  0.00} {runtime 1 84 0 69} }{global_incr_map {wns 626} {tns 0} {vep 0} {area 42} {cell_count 10} {utilization  0.00} {runtime 0 84 0 69} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 42} {cell_count 10} {utilization  0.00} {runtime 1 95 0 79} }}
...
set_db -quiet design:proj_counter .seq_reason_deleted {{{out_index_reg[3]} {{constant 0}}} {{out_index_reg[4]} {{constant 0}}} {{out_index_reg[5]} {{constant 0}}} {{out_index_reg[6]} {{constant 0}}} {{out_index_reg[7]} {{constant 0}}}}
...
set_db -quiet inst:proj_counter/g157__2398 .file_row_col {{/data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../sourcecode/rtl/proj_counter.sv 32 55}}
...
set_db -quiet inst:proj_counter/g160__5107 .file_row_col {{/data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../sourcecode/rtl/proj_counter.sv 32 55}}
set_db -quiet inst:proj_counter/g159__6260 .file_row_col {{/data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../sourcecode/rtl/proj_counter.sv 32 55}}
set_db -quiet inst:proj_counter/g158__4319 .file_row_col {{/data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../sourcecode/rtl/proj_counter.sv 35 37}}
set_db -quiet inst:proj_counter/g161__5526 .file_row_col {{/data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../sourcecode/rtl/proj_counter.sv 28 38}}
set_db -quiet inst:proj_counter/g163 .file_row_col {{/data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../sourcecode/rtl/proj_counter.sv 38 20}}
...
## Written on 16:20:17 08-Aug 2024
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid 308cb79f-339c-4400-86bf-1af2c3fdeeb8}
