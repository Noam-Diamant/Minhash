...
set_input_delay -clock [get_clocks clk] -add_delay 0.4125 [get_ports {in_data[1]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.4125 [get_ports {in_data[0]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.4125 [get_ports start_over]
...
set_output_delay -clock [get_clocks clk] -add_delay 0.4125 [get_ports full]
