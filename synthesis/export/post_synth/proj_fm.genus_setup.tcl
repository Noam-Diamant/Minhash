...
# Design
################################################################################
read_netlist -top proj_fm /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/post_synth/proj_fm.v
...
phys::read_script /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/post_synth/proj_fm.g
...
if {$_slk_ != "104.2"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 104.2,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "426"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 426,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "167"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 167,  current net area: $_net_area_"
}
unset _net_area_
