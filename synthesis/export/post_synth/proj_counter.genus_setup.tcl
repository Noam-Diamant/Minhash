...
# Design
################################################################################
read_netlist -top proj_counter /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/post_synth/proj_counter.v
...
phys::read_script /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/post_synth/proj_counter.g
...
if {$_slk_ != "625.7"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 625.7,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "43"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 43,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
