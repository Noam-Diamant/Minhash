...
# Design
################################################################################
read_netlist -top proj_extender /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/post_synth/proj_extender.v
...
phys::read_script /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/post_synth/proj_extender.g
...
if {$_slk_ != "46.4"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 46.4,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "181"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 181,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
