...
if {$_slk_ != "522.4"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 522.4,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "3027"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 3027,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
