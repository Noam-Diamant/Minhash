...
#
# Init setup file
# Created by Genus(TM) Synthesis Solution on 08/11/2024 19:12:47
#
################################################################################
if { ![is_common_ui_mode] } { error "ERROR: This script requires common_ui to be active."}

read_mmmc /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_hasher/post_synth/proj_hasher.mmmc.tcl
...
read_netlist /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_hasher/post_synth/proj_hasher.v
