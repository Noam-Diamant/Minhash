...
# Design
################################################################################
read_netlist -top proj_hasher /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_hasher/post_synth/proj_hasher.v
...
phys::read_script /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_hasher/post_synth/proj_hasher.g
...
if {$_cell_area_ != "9638"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 9638,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "3117"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 3117,  current net area: $_net_area_"
}
unset _net_area_
