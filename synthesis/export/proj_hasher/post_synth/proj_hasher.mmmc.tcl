...
create_constraint_mode -name default_emulate_constraint_mode \
    -sdc_files { /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_hasher/post_synth/proj_hasher.default_emulate_constraint_mode.sdc }
