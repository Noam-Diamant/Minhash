...
# Design
################################################################################
read_netlist -top proj_hasher /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_hasher/post_elaboartion/proj_hasher.v
read_metric -id current /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_hasher/post_elaboartion/proj_hasher.metrics.json

phys::read_script /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_hasher/post_elaboartion/proj_hasher.g

phys::read_lec_taf /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_hasher/post_elaboartion/proj_hasher.lec.taf.gz
...
if {$_cell_area_ != "28025"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 28025,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
