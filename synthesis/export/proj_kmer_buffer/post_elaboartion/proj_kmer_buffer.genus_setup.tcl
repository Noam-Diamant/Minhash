...
# Design
################################################################################
read_netlist -top proj_kmer_buffer /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_kmer_buffer/post_elaboartion/proj_kmer_buffer.v
read_metric -id current /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_kmer_buffer/post_elaboartion/proj_kmer_buffer.metrics.json

phys::read_script /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_kmer_buffer/post_elaboartion/proj_kmer_buffer.g

phys::read_lec_taf /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_kmer_buffer/post_elaboartion/proj_kmer_buffer.lec.taf.gz
...
if {$_cell_area_ != "582"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 582,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "32"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 32,  current net area: $_net_area_"
}
unset _net_area_
