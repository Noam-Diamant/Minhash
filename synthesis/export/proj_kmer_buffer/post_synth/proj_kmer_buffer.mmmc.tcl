...
create_constraint_mode -name default_emulate_constraint_mode \
    -sdc_files { /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_kmer_buffer/post_synth/proj_kmer_buffer.default_emulate_constraint_mode.sdc }
