...
#
# Init setup file
# Created by Genus(TM) Synthesis Solution on 08/11/2024 17:26:57
#
################################################################################
...
read_netlist /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_fm/post_elaboartion/proj_fm.v
