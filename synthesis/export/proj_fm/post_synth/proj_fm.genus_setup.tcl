...
# Design
################################################################################
read_netlist -top proj_fm /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_fm/post_synth/proj_fm.v
...
phys::read_script /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_fm/post_synth/proj_fm.g
...
if {$_slk_ != "4573.5"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 4573.5,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "21183"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 21183,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "13851"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 13851,  current net area: $_net_area_"
}
unset _net_area_
