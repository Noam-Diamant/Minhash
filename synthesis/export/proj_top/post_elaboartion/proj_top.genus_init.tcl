...
#
# Init setup file
# Created by Genus(TM) Synthesis Solution on 08/10/2024 23:38:15
#
################################################################################
...
read_netlist /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_top/post_elaboartion/proj_top.v
