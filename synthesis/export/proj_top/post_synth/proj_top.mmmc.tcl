#################################################################################
#
# Created by Genus(TM) Synthesis Solution 21.15-s080_1 on Tue Aug 13 11:17:31 UTC 2024
#
#################################################################################
...
create_constraint_mode -name default_emulate_constraint_mode \
    -sdc_files { /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_top/post_synth/proj_top.default_emulate_constraint_mode.sdc }
