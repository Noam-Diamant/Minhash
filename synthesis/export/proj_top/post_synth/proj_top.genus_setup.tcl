...
# Design
################################################################################
read_netlist -top proj_top /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_top/post_synth/proj_top.v
...
phys::read_script /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_top/post_synth/proj_top.g
...
if {$_slk_ != "253.6"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 253.6,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "124588"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 124588,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "70922"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 70922,  current net area: $_net_area_"
}
unset _net_area_
