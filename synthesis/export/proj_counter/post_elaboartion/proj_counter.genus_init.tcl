...
#
# Init setup file
# Created by Genus(TM) Synthesis Solution on 08/11/2024 13:40:46
#
################################################################################
...
read_netlist /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_counter/post_elaboartion/proj_counter.v
