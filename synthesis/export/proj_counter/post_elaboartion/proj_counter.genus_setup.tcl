...
# Design
################################################################################
read_netlist -top proj_counter /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_counter/post_elaboartion/proj_counter.v
read_metric -id current /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_counter/post_elaboartion/proj_counter.metrics.json

phys::read_script /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_counter/post_elaboartion/proj_counter.g

phys::read_lec_taf /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_counter/post_elaboartion/proj_counter.lec.taf.gz
...
if {$_cell_area_ != "481"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 481,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "10"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 10,  current net area: $_net_area_"
}
unset _net_area_
