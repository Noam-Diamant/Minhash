...
# Design
################################################################################
read_netlist -top proj_sorter /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_sorter/post_synth/proj_sorter.v
...
phys::read_script /data/project/tsmc65/users/noaant/ws/Minhash/synthesis/workspace/../export/proj_sorter/post_synth/proj_sorter.g
...
if {$_slk_ != "5.5"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 5.5,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "34791"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 34791,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "16547"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 16547,  current net area: $_net_area_"
}
unset _net_area_
