...
# Generated on: Wed Aug 07 19:50:39 UTC 2024 (Wed Aug 07 19:50:39 UTC 2024)
...
set logfile fv/proj_fm/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/proj_fm -revised fv_map
...
elaborate_design -golden -root {proj_fm} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/proj_fm/fv_map.v.gz
elaborate_design -revised -root {proj_fm}
...
#add_name_alias fv/proj_fm/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.proj_fm.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.proj_fm.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.proj_fm.rtl.fv_map.rpt
