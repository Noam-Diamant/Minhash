...
# Generated on: Tue Aug 06 13:59:46 UTC 2024 (Tue Aug 06 13:59:46 UTC 2024)
...
set logfile fv/proj_counter/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/proj_counter -revised fv_map
...
elaborate_design -golden -root {proj_counter} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/proj_counter/fv_map.v.gz
elaborate_design -revised -root {proj_counter}
...
#add_name_alias fv/proj_counter/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.proj_counter.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.proj_counter.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.proj_counter.rtl.fv_map.rpt
