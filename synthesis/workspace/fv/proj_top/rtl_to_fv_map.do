...
# Generated on: Sat Aug 10 23:40:02 UTC 2024 (Sat Aug 10 23:40:02 UTC 2024)
...
set logfile fv/proj_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/proj_top -revised fv_map
...
elaborate_design -golden -root {proj_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/proj_top/fv_map.v.gz
elaborate_design -revised -root {proj_top}
...
#add_name_alias fv/proj_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.proj_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.proj_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.proj_top.rtl.fv_map.rpt
