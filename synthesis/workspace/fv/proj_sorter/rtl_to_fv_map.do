...
# Generated on: Thu Aug 08 11:24:06 UTC 2024 (Thu Aug 08 11:24:06 UTC 2024)
...
set logfile fv/proj_sorter/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/proj_sorter -revised fv_map
...
elaborate_design -golden -root {proj_sorter} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/proj_sorter/fv_map.v.gz
elaborate_design -revised -root {proj_sorter}
...
#add_name_alias fv/proj_sorter/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.proj_sorter.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.proj_sorter.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.proj_sorter.rtl.fv_map.rpt
