...
# Generated on: Thu Aug 08 16:56:46 UTC 2024 (Thu Aug 08 16:56:46 UTC 2024)
...
set logfile fv/proj_extender/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/proj_extender -revised fv_map
...
elaborate_design -golden -root {proj_extender} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/proj_extender/fv_map.v.gz
elaborate_design -revised -root {proj_extender}
...
#add_name_alias fv/proj_extender/fv_map.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.proj_extender.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.proj_extender.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.proj_extender.rtl.fv_map.rpt
