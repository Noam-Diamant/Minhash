...
# Generated on: Wed Aug 07 19:53:04 UTC 2024 (Wed Aug 07 19:53:04 UTC 2024)
...
set logfile fv/proj_kmer_buffer/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/proj_kmer_buffer -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/apps/cadence/GENUS/21.15/tools"
set CDN_SYNTH_ROOT      "/apps/cadence/GENUS/21.15/tools"
set env(CW_DIR) "/apps/cadence/GENUS/21.15/tools/lib/chipware"
set CW_DIR      "/apps/cadence/GENUS/21.15/tools/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /apps/cadence/GENUS/21.15/tools/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/apps/cadence/GENUS/21.15/tools/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/apps/cadence/GENUS/21.15/tools/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/apps/cadence/GENUS/21.15/tools/lib/chipware/sim"
    set CW_DIR_SIM      "/apps/cadence/GENUS/21.15/tools/lib/chipware/sim"
}
...
add_search_path . /data/project/tsmc65/users/itaerg/ws/Final-Project/Minhash/synthesis/workspace/../sourcecode/rtl -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 -f  /data/project/tsmc65/users/itaerg/ws/Final-Project/Minhash/synthesis/workspace/../sourcecode/rtl/../dut_src_list.txt
elaborate_design -golden -root {proj_kmer_buffer} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/proj_kmer_buffer/fv_map.v.gz
elaborate_design -revised -root {proj_kmer_buffer}
...
#add_name_alias fv/proj_kmer_buffer/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.proj_kmer_buffer.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.proj_kmer_buffer.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.proj_kmer_buffer.rtl.fv_map.rpt
