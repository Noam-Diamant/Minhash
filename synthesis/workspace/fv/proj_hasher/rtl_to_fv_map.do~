...
# Generated on: Thu Aug 08 17:06:06 UTC 2024 (Thu Aug 08 17:06:06 UTC 2024)
...
set logfile fv/proj_hasher/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/proj_hasher -revised fv_map
...
elaborate_design -golden -root {proj_hasher} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/proj_hasher/fv_map.v.gz
elaborate_design -revised -root {proj_hasher}
...
set_system_mode lec
write_compared_points noneq.compared_points.proj_hasher.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.proj_hasher.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.proj_hasher.rtl.fv_map.rpt
